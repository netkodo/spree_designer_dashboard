class Spree::Admin::BoardsController < Spree::Admin::ResourceController
  ...
  def approve
    ...
    Spree::Mailers::BoardMailer.approved_room_to_designer_email(@board.designer.email,"Your room has been approved!","Hi #{@board.designer.full_name}, <br />Your room <strong>#{@board.name}</strong> has been approved and published.  You can <a href=\"#{@board.to_url}\">visit your room here</a> to check it out.",params[:board][:state_message]).deliver if params[:board][:send_message] == "on"
